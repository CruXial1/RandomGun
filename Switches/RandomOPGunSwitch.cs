    ...
    class RandomOPGunSwitch
    {
        ...
        public static void OPEnabled(IRocketPlayer caller)
        {
            ...
            switch (rng.Next(1, 53 + 1))
            {
                ...
                case 57:
                    player.GiveItem(1441, 1);
                    UnturnedChat.Say($"{player.DisplayName} has recieved a Shadowstalker Mk2, Holy moly..");
                    break;

                case 58:
                    player.GiveItem(1364, 1);
                    UnturnedChat.Say($"{player.DisplayName} has recieved a Shadowstalker Hell's Fury, Holy moly..");
                    break;
